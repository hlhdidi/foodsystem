	    ...
	    <li class="level1">
            ...
            <ul class="MenuLevel2">
            	<li class="level2 level2Style">
                    <a target="right" href="${pageContext.request.contextPath }/sys/ManagerServlet?op=showDinnerTableUI">餐桌管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/ManagerServlet?op=showFoodGroupUI">菜系管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/ManagerServlet?op=showFoodUI">菜品管理</a>
				</li>
                <li class="level2 level2Style">
                	<a target="right" href="${pageContext.request.contextPath }/sys/ManagerServlet?op=showOrderUI">餐厅订单</a>
				</li>
            </ul>
        </li>
    </ul>
