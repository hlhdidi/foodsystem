...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/sys/ManagerServlet?op=updateFood&id=${food.id}" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
							<td width="80px">菜系</td>
							<td>
                            <select name="foodGroupId" style="width:80px">
							<c:forEach items="${groups }" var="g">
								<c:if test="${g.id==food.foodGroup.id }">
						...
						<tr>
							<td width="80px">菜名</td>
							<td><input type="text" name="foodName" class="InputStyle" value="${food.name }"/> *</td>
						</tr>
						<tr>
							<td>价格</td>
						...
						<tr>
							<td>简介</td>
							<td><textarea name="introduce" class="TextareaStyle">${food.description }</textarea></td>
						</tr>
						<tr>
							...
							<td>
									...
									src="${pageContext.request.contextPath}/${food.path}">
