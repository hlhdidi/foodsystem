...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/sys/ManagerServlet?op=saveFood" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
            ...
            <div class="ItemBlock">
				<div class="ItemBlock2">
                    ...
                    <tr>
							<td width="80px">菜系</td>
							<td>
                            <select  style="width:80px" name="foodGroupId">
