...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="${pageContext.request.contextPath }/sys/ManagerServlet?op=updateFoodGroup" method="post">
				...
				<div class="ItemBlock2">
					<table cellpadding="0" cellspacing="0" class="mainForm">
						<tr>
							...
							<td>
								<input type="text" name="name" class="InputStyle" value="${group.name }"/> *
