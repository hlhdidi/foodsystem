		...
		<div id="menu1">
			...
			<div class="menu3">
				<div class="menu3_left">
					<img src="${pageContext.request.contextPath }/${food.path}"
			...
			<div class="menu4">
				<a href="${pageContext.request.contextPath }/app/ClientServlet?op=addFoodCart&id=${food.id}" style="background:url(${pageContext.request.contextPath }/app/style/images/img/order_left_corner_bg.png);">放入餐车</a>
